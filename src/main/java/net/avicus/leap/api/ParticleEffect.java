...
public enum ParticleEffect {
    ...
    NOTE("note", Environment.ANY), PORTAL("portal", Environment.ANY),
    ...
    /**
     * Setting the stack in the x,y,z axis makes another emitter in both
     * directions on each block for length of the stack
     * 
     * @param stackXAxis
     * @param stackYAxis
     * @param stackZAxis
    ...
    /**
     * This is used to send a particle effect to only one player, no one else
     * will see this.
     * 
     * @param player
     * @param count
    ...
    /**
     * This is used to send a particle effect to a location and all players near
     * it will see it
     * 
     * @param location
     * @param count
        ...
        try {
            for (Entity entity : location.getWorld().getEntities()) {
                if (entity instanceof CraftPlayer) {
                    if (entity.getLocation().distance(location) < 100) {
    ...
    /**
     * Returns the actual packet that is sent to a player This will replace id
     * and data variables for icon/tile crack as well
     * 
     * @param location
     * @param offsetX
     * @param offsetY
